        ...
        {/* Second column*/}
        {
          ...
          <>
            <div className="flex flex-col mt-4 md:mt-12 lg:ml-[130px] ml-[5rem] max-sm:ml-[30px]">
              ...
              <h4 className="text-white text-[15px] mb-4 cursor-pointer hover:text-[#004AAD]" onClick={() => {
                navigate("/contact");
              }}>
                Contact
              </h4>
            ...
            <div className="flex flex-col mt-4 md:mt-12 lg:ml-[130px] ml-[5rem] max-sm:ml-[190px]">
              ...
              <Link to="/services/mobile" className="text-white text-[15px] mb-4 hover:text-[#004AAD]">
                Mobile security
              </Link>
              <Link
              ...
              <Link to="/services/network" className="text-white text-[15px] mb-4 hover:text-[#004AAD]">
                Network security
              </Link>
              <Link to="/services/audit" className="text-white text-[15px] mb-4 hover:text-[#004AAD]">
                Audit & Compliance
              </Link>
            </div>
            {/* Fourth column*/}
            <div className="flex flex-col mt-4 md:mt-12 lg:ml-[130px] ml-[5rem] max-sm:ml-[30px]">
              ...
              <Link className="text-white text-[15px] mb-4 hover:text-[#004AAD]" to="/services/maturity">
                Maturity Assessment
              </Link>
              <Link className="text-white text-[15px] mb-4 hover:text-[#004AAD]" to="/services/virtual">
                Virtual CISO as service
              </Link>
              <Link className="text-white text-[15px] mb-4 hover:text-[#004AAD]" to="/services/staff">
                Staff & Augmentation
              </Link>
              <Link
                className="text-white text-[15px] mb-4 hover:text-[#004AAD]"
