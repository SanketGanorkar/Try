...
const Footer = () => {
  ...
  return (
    <div className="border-t-[1px] bg-[#000000] pb-2">
      <div className="flex flex-col md:flex-row ml-[55px]">
        {/* First column*/}
        ...
        {/* Third column*/}
        <div className="flex flex-col mt-4 md:mt-12 md:ml-[130px] max-sm:ml-[190px]">
      ...
      <div className="flex flex-col">
        <div className="flex flex-row">
          ...
          <div className="flex flex-col mt-4 md:mt-12 md:ml-[130px] max-sm:ml-[100px]">
            <h4 className="text-white font-semibold text-[22px]">Services</h4>
            <Link
              to="/services/cloud"
              className="text-white text-[15px] mb-4 mt-4"
      ...
      <div className="pt-2 px-2 pb-2 flex flex-col items-center mt-[40px] md:flex-row md:justify-around bg-[#000000] text-white min-h-[40px] text-center border-white">
