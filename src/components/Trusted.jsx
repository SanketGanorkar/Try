    ...
    <div className="bg-white flex flex-row min-h-[300px] justify-center items-center max-lg:flex-col max-lg:items-center">
      ...
      <div className="text-black sm:pt-10 lg:pt-0 lg:pl-10 max-lg:flex max-lg:flex-wrap max-lg:justify-center items-center sm:mt-8 max-sm:mb-5">
        <div className="flex flex-row lg:pb-5 ">
          <img src={Cashmap} className="w-28 h-28 m-1 animate-bounce  border-[2px] cursor-pointer" alt="Cashmap" />
          <img src={FoodIn} className="w-28 h-28 m-1 animate-bounce border-[2px] cursor-pointer" alt="FoodIn" />
          <img src={Moneytalk} className="w-28 h-28 m-1 animate-bounce border-[2px] cursor-pointer" alt="Moneytalk" />
        </div>
        <div className="flex flex-row lg:pb-5">
          <img src={Naviti} className="w-28 h-28 m-1 animate-bounce border-[2px] cursor-pointer" alt="Naviti" />
          <img src={Nudgebee} className="w-28 h-28 m-1 animate-bounce border-[2px] cursor-pointer" alt="Nudgebee" />
          <img src={Suzie} className="w-28 h-28 m-1 animate-bounce border-[2px] cursor-pointer" alt="Suzie" />
        </div>
      </div>
    </div>
  );
